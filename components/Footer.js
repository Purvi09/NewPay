        ...
        <div>
            <div className={styles.gridContainer}>
                <div className={styles.leftGrid}>
                    ...
                    <p style={{ fontSize: '10px' }}>
                        NewPay is a financial infrastructure platform for businesses. From well established companies to startups NewPay helps to accept payments, grow their revenue, and accelerate new business opportunities.
                    </p>
                </div>
            ...
            <div className={styles.newGrid}>
                <div style={{ display: "flex", alignItems: "center", marginLeft:"20%" }}>
                    <span style={{ fontSize: "12px" ,color:"white"}}>Email: ashish@NewPay.com </span>
                    <div className={styles.iconContainer}>
                        {/* You can add your social media icons here */}
                    </div>
                </div>
