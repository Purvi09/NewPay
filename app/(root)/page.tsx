  ...
  return (
    <div className="flex flex-col bg-[#F5F7FA]">
      ...
      <InfoType2
        ...
        code_data="curl -X POST &quot;https://test.NewPay.in/_payment<br />-H &quot;accept: application/json&quot; -H &quot;Content-Type: application/x-www-form-urlencoded&quot; -d &quot;key=JP***g&amp;txnid=txnid89315771360&amp;amount=10.00&amp;firstname=Ashish&amp;email=test@gmail.com&amp;phone=9876543210&amp;productinfo=iPhone&amp;pg=TESTPG&amp;bankcode=TESTPGNB&amp;surl=https://test-payment-middleware.payu.in/simulatorResponse&amp;furl=https://test-payment-middleware.NewPay.in/simulatorResponse&amp;hash=e8fde1b3fe55483f55047a28f0594fda7cb0fe7c510eb7a0adb8bba3094cc904c49c34e7d2f8a828b539f3410de34203c4dd58ceba9bd3be3de4eb7ef9982093&quot;"
      />
      </div>
      ...
      <InfoType3
        ...
        data={[
          {
            title: "Steps of NewPay Hosted",
            description:
              'Step 1: Make the Transaction Request to NewPay. Make the transaction request to the NewPay Test server...\nStep 2: Customer Submits Payment Details on NewPay Page. Customer selects the appropriate payment option (Credit Card, Debit Card, Net Banking, etc.) ...\nStep 3: Validate the Response From NewPay. ...\nStep 4: Verify the Payment.',
          },
         
        ]}
        code_data="curl -X POST &quot;https://test.NewPay.in/_payment&quot;
        -H &quot;Content-Type: application/x-www-form-urlencoded&quot; -d &quot;key=JP***g&txnid=txnid130958752736&amount=10.00&firstname=PayU User&email=test@gmail.com&phone=9876543210&productinfo=iPhone&surl=https://test-payment-middleware.NewPay.in/simulatorResponse&furl=https://test-payment-middleware.NewPay.in/simulatorResponse&hash=fd907b341ee39447fdf9e29522a9ce69a6b7d62af1d420eb60a0661ec67bb4dc9fdf7ba663cabb99d7436a0d67a4b9ca1f561d3a6e2df7c19cd9307e2c42b30e&quot;"
      ...
      <InfoType2
        ...
        data={[
          {
            title: "NewPay Server-to-Server",
            description:
              'The Server-to-Server integration is performed at the server level, that is, your server (merchant server) and NewPay server. The transaction is initiated from your server; hence redirection hop is eliminated.',
          },
         
        ]}
        code_data="curl -X POST &quot;https://test.NewPay.in/_payment
        -H &quot;accept: application/json&quot; -H &quot;Content-Type: application/x-www-form-urlencoded&quot; -d &quot;key=JP***g&txnid=txnid42811231360&amount=10.00&firstname=Ashish&email=test@gmail.com&phone=9876543210&productinfo=iPhone&pg=TESTPG&bankcode=TESTPGNB&txn_s2s_flow=4&surl=https://test-payment-middleware.NewPay.in/simulatorResponse&furl=https://test-payment-middleware.NewPay.in/simulatorResponse&hash=de8a3e0566e03c2f95a3eb7f61dd7bef4522076a8f3a90d1d443ae75dedb256729f0709959eb09edd5e8f77b1d95826b72951f396ea7d9c57adbbc5a201a87f4&quot;"
